...
#实体类
-keep class com.xx.yuefang.bean.**{*;}
-keep class com.xx.yuefang.database.entity.**{*;}
#自定义控件
-keep class com.xx.yuefang.ui.customview.**{*;}
...
-keep public interface com.xx.yuefang.net.HttpInterface{ *; }
...
-keepclassmembers public class com.xx.yuefang.ui.customview.URLDrawable{
<fields>;
<methods>;
public *;
private *;
