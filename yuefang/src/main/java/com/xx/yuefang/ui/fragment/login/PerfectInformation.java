...
import com.xx.yuefang.databinding.FragmentPerfectinformationBinding;
...
public class PerfectInformation extends BaseFragment {

    private FragmentPerfectinformationBinding binding;
    private RegisterBody registerBody;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_perfectinformation, container, false);
