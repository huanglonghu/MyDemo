...
public class RecommendNewsAdapter extends BaseListAdapter {

    public RecommendNewsAdapter(Context context, List datas, int res) {
                ...
                if (!TextUtils.isEmpty(url)) {
                    RxImageLoader.with(context).getBitmap(url).subscribe(
                            imageBean -> {
                                ...
                                if (bitmap != null) {
                                    bitmap = ImagUtil.compressImage(bitmap);
