        ...
        switch (mCurrState) {
            case STATE_SHRINK: {
                ...
                if (mShowToExpandHint) {
                    ...
                    ssbShrink.setSpan(mTouchableSpan, ssbShrink.length(), ssbShrink.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
                return ssbShrink;
            }
            case STATE_EXPAND: {
                ...
                ssbExpand.setSpan(mTouchableSpan, ssbExpand.length(), ssbExpand.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                return ssbExpand;
            }
        }
        return mOrigText;
