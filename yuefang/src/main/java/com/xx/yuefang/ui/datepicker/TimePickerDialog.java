...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    void sureClicked() {
        if (mPickerConfig.mCallBack != null) {
            int currentYear = mTimeWheel.getCurrentYear();
            int currentMonth = mTimeWheel.getCurrentMonth();
            int currentDay = mTimeWheel.getCurrentDay();
            mPickerConfig.mCallBack.onDateSet(currentYear + "-" + currentMonth + "-" + currentDay);
        }
        dismiss();
    }
    ...
    public static class Builder {
        ...
        public Builder PickerConfig(PickerConfig mPickerConfig) {
            this.mPickerConfig = mPickerConfig;
            return this;
        }
