...
public class UIUtils {
    ...
    public static Context getContext(){
        return YueFangApplication.getApplication();
    }
    /** dip转换px */
    public static int dip2px(int dip) {
        final float scale = YueFangApplication.getApplication().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp( float pxValue) {
        final float fontScale = YueFangApplication.getApplication().getResources().getDisplayMetrics().scaledDensity;
