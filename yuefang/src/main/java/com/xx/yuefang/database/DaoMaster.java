...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        SearchStrDao.createTable(db, ifNotExists);
        SystemDataDao.createTable(db, ifNotExists);
        UserBeanDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        SearchStrDao.dropTable(db, ifExists);
        SystemDataDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(SearchStrDao.class);
        registerDaoClass(SystemDataDao.class);
